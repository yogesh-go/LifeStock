  ...
  return (
    <div className="min-h-screen bg-[#0a0a14] flex items-center justify-center px-5"
      ...
      <div className="bg-[#1a1a2e] border border-[#2a2a3e] rounded-2xl p-10 w-full max-w-md shadow-2xl">
        ...
        <p className="text-gray-500 text-center text-sm mb-8">Prediction market for your goals</p>
        ...
        <p className="text-gray-500 text-center text-sm mt-6">
          ...
          <Link to="/register" className="text-[#00d4ff] font-semibold hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
